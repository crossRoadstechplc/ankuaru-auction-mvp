export const AUCTION_DETAILS: Record<string, any> = {
  "1": {
    ...
    measurement: "Per KG",
    quantity: "600",
    initialBid: "ETB 42.00",
    currentBid: "ETB 48.50",
    totalBids: 15,
    timeLeft: "03h 15m",
    status: "LIVE",
    image:
  ...
  "2": {
    ...
    measurement: "Per KG",
    quantity: "450",
    initialBid: "ETB 39.00",
    currentBid: "ETB 41.20",
    totalBids: 8,
    timeLeft: "05h 45m",
    status: "LIVE",
    image:
  ...
  "3": {
    ...
    measurement: "Per KG",
    quantity: "200",
    initialBid: "ETB 45.00",
    currentBid: "ETB 52.00",
    totalBids: 22,
    timeLeft: "01h 10m",
    status: "LIVE",
    image:
  ...
  "4": {
    ...
    quantity: "25000",
    initialBid: "ETB 320.00",
    currentBid: "ETB 295.00",
    totalBids: 12,
    timeLeft: "2d 04h",
    status: "LIVE",
    image:
  ...
  "5": {
    ...
    measurement: "Per KG",
    quantity: "1200",
    initialBid: "ETB 35.00",
    currentBid: "ETB 40.25",
    totalBids: 18,
    timeLeft: "Ended",
    status: "CLOSED",
    image:
