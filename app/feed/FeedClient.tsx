...
export default function FeedClient({ initialAuctions }: FeedClientProps) {
  ...
  // React Query hook for fetching auctions with initial data from SSR
  const { data: auctions = [], isLoading, error, refetch } = useAuctions(initialAuctions);
